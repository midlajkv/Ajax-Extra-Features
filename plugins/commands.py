...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        ...
        await message.reply(script.START_TXT.format(message.from_user.mention if message.from_user else message.chat.title, temp.U_NAME, temp.B_NAME), uptime = time.strftime("%Hh %Mm %Ss", time.gmtime(time.time() - BOT_START_TIME))), reply_markup=reply_markup)
